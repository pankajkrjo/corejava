...
public class TryWithResources {
	...
	public static void main(String[] args) {
		...
		try ( // Using multiple resources
				FileOutputStream fileOutputStream = new FileOutputStream("/Users/pankajkumar/Downloads/pandemo/pankaj.txt");
				//System.out.println(fileOutputStream);
				InputStream input = new FileInputStream("/Users/pankajkumar/Downloads/pandemo/pankaj.txt")) {
